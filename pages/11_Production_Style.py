...
PRODUCTION = {
    ...
    "Cool Worlds Podcast": {
        "set": "Varies: outdoor location shoots (beaches, launch sites), lecture-style studio, and documentary-style B-roll. Not a fixed studio.",
        "camera": "Multi-cam. Documentary cinematography with outdoor wide shots plus close-ups. Branded 'Cool Worlds' t-shirt.",
        "lighting": "Natural daylight for outdoor. Studio lighting for indoor segments.",
        "equipment": "Lavalier mics. Minimal visible studio equipment. Feels like a science documentary.",
        "wardrobe": "Branded Cool Worlds t-shirt. Casual, science-educator look.",
        "vibe": "Science documentary, adventurous",
        "vibe_detail": "Feels like a BBC science documentary, not a podcast. Location shooting gives cinematic quality rare for YouTube science.",
        "key_elements": "Location shooting, outdoor scenes, documentary style, branded t-shirt, science educator",
    },
    "FoundMyFitness (Rhonda Patrick)": {
        "set": "Varies: conference stages, lecture halls, studio interviews. Often filmed at health/science events with branded backdrops.",
        "camera": "Standard event coverage. Wide shot of stage plus close-ups.",
        "lighting": "Event/stage lighting. Variable quality depending on venue.",
        "equipment": "Lavalier mics. Presentation slides visible.",
        "wardrobe": "Smart casual. Earth tones. Professional but approachable.",
        "vibe": "Science conference presentation",
        "vibe_detail": "More lecture/presentation than conversation. Filmed at events and conferences rather than a dedicated studio.",
        "key_elements": "Conference stages, presentation slides, event filming, science-focused, variable locations",
    },
    "Every": {
        "set": "Bright home office/apartment. Bookshelves, couch, plants visible. Natural light from windows. 'EVERY' branding on shelf.",
        "camera": "Single camera. Medium close-up of host with mic on boom arm. Straightforward framing.",
        "lighting": "Bright, natural daylight. Airy, California apartment feel.",
        "equipment": "Podcast mic on boom arm visible. Natural, minimal setup.",
        "wardrobe": "Casual: white t-shirt, glasses. Relaxed startup-founder look.",
        "vibe": "Bright, casual startup office",
        "vibe_detail": "Feels like a smart friend talking from their apartment. The brightness and plants give an optimistic, modern feel.",
        "key_elements": "Bright daylight, bookshelves, plants, boom mic, casual white tee, apartment feel",
    },
    "Mind & Matter Podcast": {
        "set": "Home studio with purple/magenta LED accent lighting. Bookshelves with books and Buddha statue. Dark background with color accents.",
        "camera": "Single camera. Medium close-up facing camera.",
        "lighting": "Dark with purple/magenta LED accents. Moody but colorful.",
        "equipment": "Mic visible. LED strip lights provide ambiance.",
        "wardrobe": "Casual: black t-shirt.",
        "vibe": "Moody science studio",
        "vibe_detail": "The purple LEDs against dark background create a distinctive look. Buddha statue signals mindfulness/neuroscience crossover.",
        "key_elements": "Purple LED accents, dark background, bookshelves, Buddha statue, moody, science-meets-mindfulness",
    },
    "Preston Pysh": {
        "set": "Remote/Zoom multi-person format. Split-screen with 2-3 participants in their home offices. Bookshelves common in backgrounds.",
        "camera": "Webcam. Multi-person split-screen layout. Text overlay captions.",
        "lighting": "Natural, variable per participant. Standard remote podcast lighting.",
        "equipment": "Headphones visible on some participants. Standard webcam setups.",
        "wardrobe": "Smart casual. Button-down shirts.",
        "vibe": "Finance roundtable discussion",
        "vibe_detail": "Panel discussion format with multiple speakers. Bookshelves signal investing credibility. Feels like a Zoom finance seminar.",
        "key_elements": "Multi-person Zoom, split-screen, bookshelves, headphones, finance roundtable",
    },
    "A Connection TV": {
        "set": "Bedroom/home office. Plain walls with some posters. Desk with phone. Very basic, no set design.",
        "camera": "Single webcam. Screen recording overlay (reaction video format with social media content visible).",
        "lighting": "Overhead room lighting. Warm but flat. No dedicated studio lighting.",
        "equipment": "Phone in hand. No visible professional mic. Built-in camera/mic likely.",
        "wardrobe": "Very casual: tank top. At-home attire.",
        "vibe": "Lo-fi bedroom commentary",
        "vibe_detail": "Reaction/commentary format rather than interview podcast. Zero production value. Personality-driven content.",
        "key_elements": "Bedroom setup, phone in hand, reaction format, no professional equipment, lo-fi",
    },
    "Alex Kantrowitz (Big Technology)": {
        "set": "Remote/Zoom split-screen. Host and guest in separate home offices. Plain walls, some artwork visible.",
        "camera": "Webcam. Side-by-side split-screen. Branded 'Big Technology' overlay.",
        "lighting": "Natural, variable. Standard home office lighting.",
        "equipment": "Standard webcam setup. Branded overlay graphics.",
        "wardrobe": "Smart casual. Dark shirts.",
        "vibe": "Professional remote tech interview",
        "vibe_detail": "Clean remote format with branding. Functional, professional, no visual flair.",
        "key_elements": "Zoom split-screen, branded overlay, home offices, smart casual, tech journalism",
    },
    "The Cipher Brief": {
        "set": "Remote/Zoom split-screen. Host and guest in home studies. Bookshelves behind both. Wood paneling visible.",
        "camera": "Webcam. Side-by-side split. 'Cipher Brief' branding in corner.",
        "lighting": "Warm, residential. Bookshelf lighting.",
        "equipment": "Standard webcam. No professional audio visible.",
        "wardrobe": "Professional: blazer/sport coat with dress shirt. Formal for a remote podcast.",
        "vibe": "Washington insider briefing",
        "vibe_detail": "Bookshelves + blazers + national security topic = DC think tank aesthetic. Feels like a classified briefing made public.",
        "key_elements": "Bookshelves, blazers, Zoom split-screen, DC think tank feel, branded corner logo",
    },
    "threadguy": {
        "set": "Decorated studio/streaming room. Wooden shelving with neon Polymarket ghost logo. Crypto/DeFi branded decor. Coffee cup. Warm, lived-in streaming setup.",
        "camera": "Single camera. Medium shot with full background visible. Streaming overlays and tickers.",
        "lighting": "Warm with purple/blue neon accents from branded signs. Well-lit face.",
        "equipment": "Mic visible. Streaming overlay graphics, Twitch branding. Live chat ticker.",
        "wardrobe": "Very casual: hoodie, messy hair. Gen-Z crypto-native look.",
        "vibe": "Crypto streamer den",
        "vibe_detail": "Feels like a Twitch stream that happens to discuss finance. Neon branding, streaming overlays, and casual energy. Very different from traditional finance podcasts.",
        "key_elements": "Neon Polymarket logo, streaming overlays, wooden shelving, crypto decor, hoodie, streamer energy",
    },
    "Bay Bridge Bio": {
        "set": "Home office/remote. Plain walls, some plants and speakers visible. Earbuds for audio. Very basic setup.",
        "camera": "Webcam. Single frame on host.",
        "lighting": "Natural, slightly washed out. No studio lighting.",
        "equipment": "Apple earbuds for audio. No professional mic visible.",
        "wardrobe": "Casual: button-down shirt, relaxed.",
        "vibe": "Casual home office podcast",
        "vibe_detail": "Minimum viable podcast setup. The content (biotech) is the draw, not the production.",
        "key_elements": "Home office, earbuds, webcam, plain walls, minimum viable production",
    },
    "Searching for Mana": {
        "set": "Remote/Zoom. Plain white/gray wall behind host. Minimal background. Branded 'Searching for Mana' and 'London Stock Exchange' overlay.",
        "camera": "Webcam. Close-up on host. Earbuds visible.",
        "lighting": "Natural, slightly overexposed. Office-standard.",
        "equipment": "Earbuds. Branded overlays. Standard webcam.",
        "wardrobe": "Smart casual: sweater/knit.",
        "vibe": "Institutional remote interview",
        "vibe_detail": "London Stock Exchange branding adds institutional weight. But the visual production is basic webcam. Content credibility over visual polish.",
        "key_elements": "White wall, earbuds, LSE branding, webcam, institutional but lo-fi",
    },
    "Michael Coppola": {
        "set": "Warm home studio. Bookshelves with books and decor in background. Shallow depth of field (blurred background). Professional framing.",
        "camera": "Single camera. Medium close-up with blurred bookshelf background. Good cinematic framing for a small channel.",
        "lighting": "Warm, even. Good quality for the channel size. Soft key light.",
        "equipment": "Lavalier mic (not visible). Clean frame.",
        "wardrobe": "Smart casual: blue button-down shirt.",
        "vibe": "Polished small-channel studio",
        "vibe_detail": "Punches above its weight visually. Blurred bookshelf background and warm lighting look professional despite 395 subscribers.",
        "key_elements": "Blurred bookshelf, warm lighting, clean frame, smart casual, above-average production for size",
    },
    "Cleaning Up Podcast": {
        "set": "Remote/Zoom format. Variable backgrounds per episode.",
        "camera": "Webcam. Standard remote interview layout.",
        "lighting": "Variable, natural.",
        "equipment": "Standard webcam setup.",
        "wardrobe": "Smart casual to casual.",
        "vibe": "Professional remote interview",
        "vibe_detail": "Standard remote podcast format focused on energy/climate content.",
        "key_elements": "Remote/Zoom, variable backgrounds, content-focused, energy/climate niche",
    },
}
